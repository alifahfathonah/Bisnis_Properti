...
$objPHPExcel->setActiveSheetIndex(0)
			->mergeCells('A1:I1')
			->setCellValue('A1','Laporan Pengunjung ALL');
...
include "../koneksi.php";
$query=mysql_query("SELECT * FROM counter WHERE id_user='$id_user' ORDER BY 'tanggal_counter' DESC");
...
header('Content-Disposition: attachment;filename="datapengunjungall.xlsx"');
