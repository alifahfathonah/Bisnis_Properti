...
include "../koneksi.php";
$query = mysql_query("SELECT * FROM properti WHERE keaktifan=1 AND id_user='U78555' AND tanggal_dibuat >'$tanggal1' AND tanggal_dibuat<'$tanggal2 23:59:59' ORDER BY 'id_properti' ASC");
...
header('Content-Disposition: attachment;filename="dataproperti'.$id_user.'.xlsx"');
