...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index.html"> <img src="logo.png" class="hidden-sm"/>
                <span>Home</span></a>
            ...
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <ul class="thumbnails gallery">
                                ...
                                <a style="background:url(gbdata/logo.png)"
                                   title="Sample Image 1" href="gbdata/logo.png"><img
                                        class="grayscale"
                                        alt="Sample Image 0"></a>
                            </li>
                                                    <li id="image-2" class="thumbnail">
                                <a style="background:url(gbdata/ClassicLeft.bmp)"
                                   title="Sample Image 2" href="gbdata/ClassicLeft.bmp"><img
                                        class="grayscale"
