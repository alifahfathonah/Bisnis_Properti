...
function docReady() {
    ...
    if ($('.tour').length && typeof(tour) == 'undefined') {
        ...
        tour.addStep({
            ...
            placement: "top",
            title: "Tour Dimulai", /* title of the popover */
            content: "Klik Next Untuk Melanjutkan, Prevorius Untuk kembali, Dan End Tour Untuk Berhenti Tour" /* content of the popover */
        });
        tour.addStep({
            element: ".theme-container",
            placement: "left",
            title: "Tema",
            content: "Tema Dapat Anda ganti Di bagian sini."
        });
        tour.addStep({
            element: "ul.main-menu a:first",
            title: "Menu",
            content: "[Dashboard] Menampilkan Halaman Utama Saat masuk."
        });
		tour.addStep({
            element: ".dropdown-toggle",
			placement: "left",
            title: "Panel User",
            content: "Edit User dan Logout."
        });
		tour.addStep({
            element: "ul.main-menu a:first",
            title: "Menu",
            content: "[Tambah Data] Berguna Untuk Menambahkan Suatu data"
        });
        tour.addStep({
            element: "ul.main-menu a:last",
            title: "Menu",
            content: "[Keluar] berfungsi Untuk Keluar atau Logout"
        });
        tour.restart();
    }
    ...
    $('.datatable').dataTable({
        ...
        "oLanguage": {
            "sLengthMenu": "_MENU_ Item Per Halaman"
        }
    });
