...
<div class="row">
	...
	include "koneksi.php";
	$no = 1;
	$query = mysqli_query($con,"SELECT * FROM properti WHERE keaktifan=1 AND id_user='ADMIN' ORDER BY tanggal_dibuat DESC");
		echo"<thead>
		<tr>
    ...
    {   $id_properti = $hasil['id_properti'];
		...
		include "koneksi2.php";
						$query_p= mysqli_query($con,"SELECT * FROM kecamatan where id_kec='$lokasi'");
