...
$query=mysqli_query($con,"SELECT * FROM properti WHERE status='Terjual'");
$terjual=mysqli_num_rows($query);
$query=mysqli_query($con,"SELECT * FROM properti WHERE status='Disewa'");
$disewa=mysqli_num_rows($query);
$query=mysqli_query($con,"SELECT status FROM properti WHERE status='Tersedia'");
