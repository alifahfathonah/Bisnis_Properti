...
<div class="ch-container">
	...
	?>
		<div class="alert alert-success">
			<button type="button" class="close" data-dismiss="alert">&times;</button>
			<strong>Operasi Sukses</strong> Data Sudah Diposting Kembali</a>
		</div>
		<?php
		}
	...
	else if (isset($_GET['hapus_permanen']))
	{
	?>
		<div class="alert alert-danger">
			<button type="button" class="close" data-dismiss="alert">&times;</button>
			<strong>Operasi Sukses</strong> Data Sudah Berhasil Dilenyapkan
		</div>
	<?php
		}
	?>
...
<div class="row">
    ...
    {   $id_properti = $hasil['id_properti'];
		...
		echo"<td >$nama</td>
			...
			echo"<a href='restore.php?id=$id_properti' type='button' class='btn btn-xs btn-success'>
			<i class='glyphicon glyphicon-refresh'></i> Restore</a>";
			}
			if ($id_user==$sesi)
			{
			echo"
	...
	{		
		...
		echo"<td >$nama</td>
			...
			echo"
			<a onclick='return konfirmasi()' href='permanen_data.php?id=$id_properti' type='button' class='btn btn-xs btn-danger' >
			<i class='glyphicon glyphicon-trash'></i></a>";
