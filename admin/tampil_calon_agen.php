...
$no=1;
$query= mysqli_query($con,"SELECT * FROM user WHERE id_status LIKE 'S003'");
...
while($hasil = mysqli_fetch_array($query)) 
	...
	<div class="box col-md-4">
        <div class="box-inner">
					...
					<h2><i class="glyphicon glyphicon-user"></i> <?=$nama;?></h2>					
					
					<?php if(($id_user==$_SESSION['id_user'])or($_SESSION['id_user']=='SUPERUSER')){ ?>
					<div class="box-icon">
					<a href="edit_user.php?id_user=<?=$id_user;?>" class="btn btn-round btn-default"><i class="glyphicon glyphicon-pencil"></i></a>
					...
					<div class="box-content">
						<ul class="nav nav-tabs" id="myTab">
							<li class="active"><a href="#info<?=$no;?>">Info</a></li>
							<li class=""><a href="#custom<?=$no;?>">Custom</a></li>
