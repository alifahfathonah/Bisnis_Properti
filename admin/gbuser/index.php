  ...
  <link rel="stylesheet" href="http://demo.itsolutionstuff.com/plugin/croppie.css">
	  	...
	  	<div class="row">
	  		...
	  		<div class="col-md-4" style="">
				<div id="upload-demo-i" style="background:#e1e1e1;width:120px;height:160px;margin-top:30px">				
				</div>
	...
	<div class="col-md-4 text-center">
		<a href="tampil_user.php" class="btn btn-default">SELESAI</a>		
	</div>
	<div class="col-md-4 text-center">
