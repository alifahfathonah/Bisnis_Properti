...
<?php
	$query_edit_user=mysqli_query($con,"select * from user where id_user='$id_u'");
    ...
    <div class="box col-md-8">
        <div class="box-inner">
            ...
            <div class="box-content">
                <form id="formalin" role="form"  action="up_user.php" method="POST" name="input">
							...
							<label>Pertanyaan Keamanan</label>
                                <select class="form-control"  name="key_tanya">
                                    <option selected ><?=$key_tanya?></option>
							...
							<div class="form-group">
							<label>Jawaban</label>
								<input  type="text" name="key_jawab" value="<?=$key_jawab?>" class="form-control" required maxlength="100"/>
							</div>	
							<div class="form-group">
							<label>Pesan</label>
		...
		<div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-picture"></i> Foto Agen</h2>

                <div class="box-icon">                    
					<a href="input_foto.php?name_foto=<?=$foto?>" class="btn btn-round btn-default"><i
			...
			<div class="box-content">
				<img src="gbuser/temp/<?=$foto?>" width="100%"></img>
            </div>
		</div>		
    </div>
    <!--/span-->
