...
if (!isset($_GET['id'])){
		...
		$id= $_GET['id'];
		$query = mysql_query("SELECT *, DATE_FORMAT(tanggal_user, '%d %M %Y') AS tanggal_bergabung FROM user where id_user='$id'");
		$jumlahdata=mysql_num_rows($query);
		if ($jumlahdata < 1){
				header("location:404.html");
			exit;
		}
		$query_user2= mysql_query("SELECT * FROM user WHERE id_user='$id'");
			while($hasiluser2 = mysql_fetch_array($query_user2))
				...
				$query_dok= mysql_query("SELECT * FROM dokumen WHERE id_dokumen='$id_dokumen'");
				while($hasildok = mysql_fetch_array($query_dok))
				{
				$foto = $hasildok['foto'];
				}	
	}
	...
	<section>
		<div class="container">
			<div class="row">
				<div class="col-sm-9">
					<div class="col-sm-12">
						<h2 class="title text-center">DATA AGEN</h2>
						<?php
						include "admin/koneksi.php";
						...
						<div class="col-sm-6">							
							<div class="contact-form">
								...
								<form id="formulir" class="contact-form row" name="input" method="post" action="proses_pesan.php" enctype="multipart/form-data">
									...
									<div class="form-group col-md-12">	
										<input  type="text" name="nomor_hp" class="form-control" required placeholder="Nomor Hp"/>
									</div>
									<div class="form-group col-md-12">
									...
									<input type="hidden" name="vali" required value="2">                    
									<div class="form-group col-md-12">
						...
						<div class="col-md-6">
							<div class="col-md-6">
								<img width="100%" src="admin/gbuser/temp/<?=$foto?>"></img>
							</div>
							<div class="col-md-6">
								<h4 class="title"><?=$nama?></h4>
								<p><i class="fa fa-envelope"> <?=$email?></i></p>
								<p><i class="fa fa-phone"> <?=$nomor_hp?></i></p>
								<p><i class="fa fa-home"> <?=$alamat?></i></p>
								<p><i class="fa fa-user"> <?=$jenis_kelamin?></i></p>
							</div>
							<div class="col-md-12">
							<br>
								<i>Pesan : <?=$pesan?></i>
						...
						<div class="col-sm-3">
							<div class="product-image-wrapper">
								<div class="single-products">
										...
										<div class="productinfo text-center col-md-12">
